        ...
        return(
                ...
                <div className="container-rigth ac">
                    <div className="card card-login">
                            ...
                            <form className="mt-5">
                                <input className="input-1 mt-2 ac" placeholder="nome"/>
                                <input className="input-1 mt-4 ac" placeholder="email"/>
                                <input className="input-1 mt-4 ac" placeholder="senha"/>
                                <input className="input-1 mt-4 ac" placeholder="Confirme a senha"/>
                            </form>
